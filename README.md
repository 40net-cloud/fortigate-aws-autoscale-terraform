...
- The official repository containing the Terraform modules and examples are [https://github.com/fortinet/terraform-aws-cloud-modules](https://github.com/fortinet/terraform-aws-cloud-modules) <br>
